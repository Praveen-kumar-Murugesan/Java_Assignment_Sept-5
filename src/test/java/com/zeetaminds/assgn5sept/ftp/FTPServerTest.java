...
class FTPServerTest {
    ...
    void setUp() throws IOException {
        ...
        is = mock(BufferedInputStream.class);
    ...
    void testGetCommand_FileExists() throws IOException {
        ...
        Command getCommand = new GetCommand(testFile.getName());
        getCommand.execute(is, os);
    ...
    void testPutCommand() throws IOException {
        ...
        Command putCommand = new PutCommand("testFile.txt");
